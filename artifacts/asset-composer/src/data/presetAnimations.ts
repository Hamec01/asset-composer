...
function makeHumanoidClips(family: SkeletonFamilyId, extra: AnimationClip[] = []): AnimationClip[] {
  ...
  const run: AnimationClip = {
    ...
    layers: [
      ly("lower_body", [
        tr("root", [kf(0,0,-2), kf(125,0,-1), kf(250,0,-2), kf(375,0,-1), kf(500,0,-2)]),
        tr("hip_l", [kf(0,-3,0,-22), kf(125,-2,0,-6), kf(250,2,0,20), kf(375,-1,0,-4), kf(500,-3,0,-22)]),
        tr("knee_l", [kf(0,-3,1,12), kf(125,-2,0,6), kf(250,1,-1,-8), kf(375,-2,1,16), kf(500,-3,1,12)]),
        tr("foot_l", [kf(0,-5,2,6), kf(125,-3,1,2), kf(250,3,-1,-8), kf(375,-4,2,10), kf(500,-5,2,6)]),
        tr("hip_r", [kf(0,3,0,20), kf(125,2,0,-4), kf(250,-3,0,-22), kf(375,2,0,-6), kf(500,3,0,20)]),
        tr("knee_r", [kf(0,3,-1,-8), kf(125,2,1,16), kf(250,-1,1,12), kf(375,2,0,6), kf(500,3,-1,-8)]),
        tr("foot_r", [kf(0,5,-1,-8), kf(125,4,2,10), kf(250,-3,2,6), kf(375,3,1,2), kf(500,5,-1,-8)]),
        tr("pelvis", [kf(0,0,0,3), kf(125,0,0,-3), kf(250,0,0,3), kf(375,0,0,-3), kf(500,0,0,3)]),
      ]),
      ly("upper_body", [
